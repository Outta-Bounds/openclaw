...
export OPENCLAW_INSTALL_CLAUDE_CODE="${OPENCLAW_INSTALL_CLAUDE_CODE:-1}"
...
if [[ "$IMAGE_NAME" == "openclaw:local" ]]; then
  ...
  run_docker_build \
    ...
    --build-arg "OPENCLAW_INSTALL_CLAUDE_CODE=${OPENCLAW_INSTALL_CLAUDE_CODE}" \
